            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('social_links.update', $info->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-6 mb-5">
                                        ...
                                        <input value="{{ $info->translate('ar')->name }}" type="text" class="form-control" name="name_ar" required />
                                        @error('name_ar')
                                    ...
                                    <div class="col-md-6 mb-5">
                                        <label class="form-label">{{ __('translations.social_links-name_en') }} <span
                                                class="text-danger">*</span></label>
                                        <input value="{{ $info->translate('en')->name }}" type="text" class="form-control" name="name_en" required />
                                        @error('name_en')
                                            <div class="fv-plugins-message-container invalid-feedback">
                                                <strong>{{ $message }}</strong>
                                            </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input value="{{ $info->icon }}" type="text" class="form-control" id="icon" name="icon" required>
                                        @error('icon')
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input value="{{ $info->link }}" type="text" class="form-control" id="link" name="link">
                                        @error('link')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
