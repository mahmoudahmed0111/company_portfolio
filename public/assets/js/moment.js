!(function (e, t) {
        ...
        return e.isValid()
            ? ((t = le(t, e.localeData())),
              (ae[t] =
                  ...
                  (function (s) {
                      for (
                          var e, i = s.match(ie), t = 0, r = i.length;
                          t < r;
                          t++
                      )
                          oe[i[t]]
    ...
    function Ct(e) {
        ...
        if (G(s)) e._d = s;
            ...
            var r,
                ...
                h = e;
            if (0 === h._f.length)
                (y(h).invalidFormat = !0), (h._d = new Date(NaN));
            else {
    ...
    function Ft(e) {
        ...
        (this._isValid = (function (e) {
            for (var t in e)
                if (-1 === b.call(Ut, t) || (null != e[t] && isNaN(e[t])))
                    return !1;
